...
<body>
	...
	function do_onload()
	{
		...
		setTimeout("jQuery(window).data('grid_scroll',jQuery('div.ui-jqgrid-bdiv').scrollTop()); jQuery(window).data('grid_selection', jQuery('#list1').jqGrid('getGridParam','selarrrow')); jQuery('#list1').trigger('reloadGrid',[{page:1}])",10000);
	}
	</script>
</body>
</html>